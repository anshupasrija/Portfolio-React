        ...
        <div id="work" className="work">
            <div className="work__item">
                ...
                <img src={rentpic} alt="rentpic" className="work__image" />
                    ...
                    <p className="work__item__paragraph">I developed Rent A Bin app while in school as my final capstone assignment. Given 10 days, we had to come up with an idea for a web application that would solve some type of issue. I built Rent A Bin, a application that allows you to book the plastic bins for moving .
